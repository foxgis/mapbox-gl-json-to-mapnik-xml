    ...
    if (invisisble(layer)) {
        ...
        for (var p in gstyle) {
            ...
            if (key !== '') {
                ...
                //}
                if (key == '@file') {
                    line_symbol.LinePatternSymbolizer[key] = path.join(filedir, gstyle[p]).replace(/\\/g,'\/');
                }
                else if (key == '@offset') {
...
function fillTranslate(layer, filedir) {
    if (invisisble(layer)) {
        ...
        for (var p in gstyle) {
            ...
            if (key !== '') {
                if (key == '@file') {
                    fill_symbol.PolygonPatternSymbolizer[key] = path.join(filedir, gstyle[p]).replace(/\\/g,'\/');
                }
                else {
    ...
    if (invisisble(layer)) {
        ...
        for (var p in gstyle) {
            if (p == 'circle-radius') {
                ...
                symbolizer.MarkerSymbolizer['@transform'] = 'translate' + '\('+gstyle[p].join()+'\)';
            }
            else {
