    ...
    symbols_arr.forEach(function (e) {
        ...
        if (n >= symbols_arr.length) {
            rules.forEach(function (e) {
                ...
                if (e.LineSymbolizer) {
                    if (e.LineSymbolizer['@stroke-dasharray']) {
                        var width = e.LineSymbolizer['@stroke-width'] ? e.LineSymbolizer['@stroke-width'] : 1;
                        var arr=e.LineSymbolizer['@stroke-dasharray'].map(function (x) {
                            return x * width;
                        });
                        e.LineSymbolizer['@stroke-dasharray']=arr.join();
                    }
                }
            })
            callback(null, rules)
